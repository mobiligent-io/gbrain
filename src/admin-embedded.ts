...
import A_0_assets_index_CfM3s4_H_css from '../admin/dist/assets/index-CfM3s4_H.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CrTXaYMl_js from '../admin/dist/assets/index-CrTXaYMl.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CfM3s4_H.css": { path: A_0_assets_index_CfM3s4_H_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-CrTXaYMl.js": { path: A_1_assets_index_CrTXaYMl_js as unknown as string, mime: "application/javascript; charset=utf-8" },
