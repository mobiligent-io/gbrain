...
import A_0_assets_index_MWOvKkql_css from '../admin/dist/assets/index-MWOvKkql.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_lJff_No7_js from '../admin/dist/assets/index-lJff-No7.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-MWOvKkql.css": { path: A_0_assets_index_MWOvKkql_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-lJff-No7.js": { path: A_1_assets_index_lJff_No7_js as unknown as string, mime: "application/javascript; charset=utf-8" },
