...
import A_0_assets_index_Co1Wpwxg_css from '../admin/dist/assets/index-Co1Wpwxg.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_DDLWDoaV_js from '../admin/dist/assets/index-DDLWDoaV.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-Co1Wpwxg.css": { path: A_0_assets_index_Co1Wpwxg_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-DDLWDoaV.js": { path: A_1_assets_index_DDLWDoaV_js as unknown as string, mime: "application/javascript; charset=utf-8" },
