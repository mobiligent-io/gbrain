...
> **Editor's Note (v0.38.3.0):** This report was contributed verbatim from
> PR #1299 (`garrytan-agents`). Two findings were re-diagnosed during the
> v0.38.3.0 wave; see `CHANGELOG.md` for corrections:
>
...
>
> All 2 bugs and 10 warnings are addressed in v0.38.3.0. The report below
