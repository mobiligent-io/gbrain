...
import A_0_assets_index_AtmsQ4Xz_css from '../admin/dist/assets/index-AtmsQ4Xz.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_B3PC_bvH_js from '../admin/dist/assets/index-B3PC-bvH.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-AtmsQ4Xz.css": { path: A_0_assets_index_AtmsQ4Xz_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-B3PC-bvH.js": { path: A_1_assets_index_B3PC_bvH_js as unknown as string, mime: "application/javascript; charset=utf-8" },
